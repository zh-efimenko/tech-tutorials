...
- Spring Boot 4.1+
- Gradle 9.x
- Docker Desktop / Docker Engine + Docker Compose (минимум 2.2.0; на актуальных сборках — 5.x)
...
| 4  | Автоконфигурация подключений | `04_auto_configuration/` | Как Spring Boot читает compose-файл и настраивает DataSource, Redis, Hazelcast без явных properties |
